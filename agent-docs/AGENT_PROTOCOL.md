...
> **Image generation:** Always use `gpt-image` (resolves to `gpt-image-2`) as the default. It supports text rendering, multi-reference compositing, and flexible sizes up to 2K.
